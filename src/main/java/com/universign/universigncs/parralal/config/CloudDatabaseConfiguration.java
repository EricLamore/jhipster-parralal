package com.universign.universigncs.parralal.config;
...
@Configuration
@EnableMongoRepositories("com.universign.universigncs.parralal.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.universign.universigncs.parralal.config.dbmigrations");
